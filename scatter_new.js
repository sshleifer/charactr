...
(function() {
  var addXax, center, dispatch, exp, height, margin, re2, svg, tabulate, tabwidth, tooltip, width, xAxis, xMap, xScale, xValue, yAxis, yMap, yScale, yValue;
  ...
  dispatch.on("load.menu", function(data) {
    var select;
    select = d3.select('.page').append('div').append('select').attr({
      'class': 'select'
    }).style({
      'fill': "red"
    });
